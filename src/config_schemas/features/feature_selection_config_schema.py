...
class feature_selection_Config:
    local_save_dir = "data/feature-selected/double"
    ...
    unencoded_features: list = field(
        default_factory=lambda: ['CryoSleep', 'Destination', 'VRDeck', 'Cabin_deck', 'HomePlanet', 'Consumption_High_End', 'Consumption_Basic']
    )
